      ...
      <div className="flex flex-col p-8 bg-white rounded-lg shadow-2xl max-w-6xl mx-auto">
        ...
        <div className="mt-6 flex gap-8">
          <div className="w-1/3">
            ...
            <div className="flex flex-col space-y-3">
              <Link href="/dashboard/settings/account">
                <p className="text-lg w-50 hover:bg-indigo-100 hover:underline rounded-lg p-2">
                  Account
                </p>
              </Link>
              <Link href="/dashboard/settings/notifications">
                <p className="text-lg w-50 hover:bg-orange-100 hover:underline rounded-lg p-2">
                  Notifications
                </p>
              </Link>
              <Link href="/dashboard/settings/profile">
                <p className="text-lg w-50 hover:bg-green-100 hover:underline rounded-lg p-2">
                  Profile
                </p>
              </Link>
            </div>
          ...
          <div className="flex-1 shadow-md p-6 rounded-lg bg-gray-50">
            <h2 className="font-bold text-2xl mb-2">Select a Settings</h2>
            <p className="text-lg">
