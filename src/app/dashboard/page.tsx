        ...
        <div className="flex justify-center bg-orange-200 h-screen">
            <div className="flex-col bg-white h-fit p-4 m-8 rounded-xl shadow-lg shadow-white/50 ">
                ...
                <div className="flex mt-4">
                    ...
                    <div className="p-2 rounded-xl bg-indigo-100 hover:bg-indigo-300 text-black mt-4 mr-4">
                   ...
                   <div>
                    ...
                    <div className="p-2 rounded-xl bg-blue-200 hover:bg-blue-400 text-black mt-4">
